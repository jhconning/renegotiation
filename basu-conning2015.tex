...
%TCIDATA{LastRevised=Saturday, April 04, 2015 13:06:02}
...
%TCIMACRO{\QTR{frametitle}{Motivation 1--The Commitment Problem}}%
%BeginExpansion
...
%TCIMACRO{\QTR{frametitle}{Motivation 2--Market Structure \& Governance}}%
%BeginExpansion
...
%TCIMACRO{\QTR{frametitle}{Motivation 2a--Governance}}%
%BeginExpansion
...
%TCIMACRO{\QTR{frametitle}{Motivation 2b--Market Structure}}%
%BeginExpansion
...
\subsection{The Possibility of Renegotiation}
...
We continue to have $\hat{c}_{1}=\hat{c}_{2}\equiv\hat{c}_{f}$.
...
\]
which if \frame{$\delta=1/(1+r)$} implies that at an optimum $c_{0}%
...
%function of $\beta\,$. Dotted line: $\delta=.9$. Solid line: $\delta=.5$. In
