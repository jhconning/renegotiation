...
\end{equation}
One's reaction function is depicted by the line passing through YP in the left quadrant of Figure \ref0{fig:twoquad}.  As  long as $\beta< 1$,  it is easy to establish that line YP is everywhere steeper than line MF.  For any given period 0 consumption level, One wants to consume  more in period 1 and less in period 2 compared to Zero's preferences.
