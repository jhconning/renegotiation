...
\maketitle
\begin{abstract}
When do financial intermediaries offer the `commitment services' that may help present-biased consumers  stick to  long-term  responsible savings accumulation and/or debt management plans and when do they instead aim to profit by pandering to their clients' weakness in self-control?  This paper builds
a simple model of saving \textit{cum} lending and refinance to   hyperbolic discounters to serve as a framework for studying a problem of consumer protection that survives even when
consumers are sophisticated and fully informed. A consumer would like
...
selves may be tempted to `raid'  savings and/or  roll over or take on new debt obligations by subsequent contract renegotiation offers.  Investor-owned banks may find it especially costly to commit to not engage in 
 such opportunistic `exploitation'  client's  changing preferences as  bank owners' profits increase by charging to do so. We analyze how  bank principals may strategically adjust bank ownership/governance forms to market structures and the distribution of consumer types  in an effort to expand the feasible equilibrium set of renegotiation-proof (credible commitment) contracts and capturable profits. We describe a theory of commercial non-profits and client protection similar to \cite{hansmann_ownership_1996}  but set on new behavioral microfoundations. Non-profit or `hybrid'  bank ownership forms (e.g. where social investor shareholders temper bank profit objectives) may be able to offer commitment services at lower cost as ownership limitations on the distribution of profits weakens banks' incentive to renegotiate
contracts. Optimal contract and ownership forms vary with whether the market structure is competitive or concentrated and with elements in the legal environment such as the forceability of exclusive contracts.
The model helps make sense several historical facts and recent developments in in consumer
banking, microfinance, and mortgage and payday lending. JEL Codes: O16, D03,
D18
...
Hyperbolic discounters -- consumers with present-biased preferences -- are those who struggle to stick to  their long-term asset accumulation or debt management plans and for that reason can benefit from
the `commitment services'  or  designed restrictions that a financial intermediary may build into multi-period financial contracts.   Long-term consumption smoothing goals are more likely to be achieved where customers can trust financial intermediaries to act as partner in resisting interim temptations to raid savings and/or   roll over debt or take on new loans in ways that could undermine  those long-term plans.
But commitments can be broken and the same person who first demanded a commitment
contract from a bank will often later want to renegotiate on terms that increase the bank's ex-post profits. Given the nature of the problem credible, renegotiation-proof commitments  that would satisfy the fears of a sophisticated pesent-biased consumer may be costly to construct and this can seriously limit the
feasible contract sets and therefore the commitment services that can be offered in equilibrium. In this paper we view the provision of commitment as an important
element of consumer protection in banking. Our goal is to provide a framework
for analyzing real-world settings where commitment is demanded but
cannot be credibly provided and study the costly contract forms and financial intermediary ownership adaptations that are likely to  endogenously emerge to ameliorate but not necessarily completely these problems.        

Consumer protection in banking is an area of major policy concern.
The worry that we focus on is that a financial
intermediary
may try to pander to the present bias of their time-inconsistent customers by encouraging them to roll over existing debts or take on new ones that boost current consumption and bank fees but undermine customers' long-term responsible debt management or asset accumulation plans.  The issue of excessive refinancing and `overindebtedness' has ben raised as an important concern in he United States.    On the eve of the mortgage banking crisis in 2007, over 70 percent of new subprime mortgage loans were refinances
of existing mortgages and approximately 84 percent of these were `cash out' refinances. These consumers were in effect drawing down their savings  in the form of illiquid home equity to take out new consumption loans (\cite{demyanyk_understanding_2011}).  In the market for payday loans the  concern of many economists and regulatory observers is not so much that fees are high for one-time short-term loans (typical cost is 15\% of the amount borrowed on a 2 week loan) but rather that in practice over 80 percent of payday loans are `rolled over' or renewed rather than paid off, incurring a new fee each time. Approximately half of all payday loans are rolled over in sequences lasting 7 or more turns resulting in very high  total loan costs and by many accounts placing many people into  unsustainable debt management situations (\cite{DeYoung_2015}.  Similar consumer protection concerns have been raised about microfinance in developing countries. 
 ...
 The properties of \textit{costlessly}-enforced optimal
commitment banking contracts have been examined in several theoretical papers
(\cite{laibson_golden_1997} and\ CITE\ OTHERS) and a number of randomized controlled trials and other empirical studies have   found quite large impacts from introducing new commitment service savings products (see for example \cite{Thaler_Benartzi_2004}, \cite{ashraf_tying_2006} and the studies cited in the survey by \cite{bryan_commitment_2010}). 

For example, in a well-cited study, \cite{ashraf_tying_2006} carried out a randomized control trial (RCT)\ that demonstrated   considerable  latent demand for commitment-savings products among poor rural savers in the Philippines. Consistent with behavioral theory they found that take-up was more likely among those who had been earlier identified as more present-biased from survey questions. They found that the introduction of a new commitment savings product which differed from existing savings accounts only in imposing new restrictions on withdrawals before   a specific date or savings goal had been reached, resulted in higher overall saving rates. Similar effects have been found in a range of other studies.

The value that consumers place on  commitment services is evident    



  \  

But commitments can be undone and the same person who first demanded a commitment
contract would  renegotiate on terms that increase the bank's ex-post profits. Credible commitments to not renegotiate are costly to construct and this limits the
feasibility of commitment.

In this paper, we take seriously the possibility that a commitment
contract would be renegotiated in the future. When a bank offers a
consumer a contract (and a corresponding consumption path) how does
it sustain its promise to not prey upon the consumer's future
temptations? We ask how a limited ability to make such a promise affects
contracts, and whether a bank can take steps that would allow it to
more credibly commit to commitment. In particular, we show how equilibrium
contracts are affected by the renegotiation problem across consumer
types and market structures. We also make predictions about how banks
endogenously make governance choices in response to the problem. 

Consumer protection in banking is an area of major policy concern.
While this is typically taken to refer to problems of hidden fees
or bank's moral hazard, we view the provision of commitment as another
element of consumer protection. Our goal is to provide a framework
for analyzing real-world settings where commitment is demanded but
cannot be credibly provided. Through our analysis we are able to make
some new theoretical observations and also shed light on certain stylized
facts and trends.

Consider an individual who signs a borrowing or commitment savings
contract with a bank to smooth consumption. If she is a hyperbolic
discounter, her preferences, and correspondingly her notions of smooth
consumption, change over time. In fact, one objective of the contract
is to prevent the consumer's `future selves' from deviating from the
planned consumption path. But when the future arrives, it is as a
result of this desire to deviate that the consumer and the bank may
find it mutually beneficial to renegotiate the contract (to defer
debt or reduce short-term savings). A \textit{sophisticated} hyperbolic
discounter anticipates this, so the bank must offer her a renegotiation-proof
contract at the outset. A \emph{naive} hyperbolic discounter fails
to anticipate this, so the bank can offer a contract that exploits
this.\footnote{A `sophisticated' hyperbolic discounter is one who is fully aware
of her time-inconsistency. A naive hyperbolic discounter believes
she is not a hyperbolic discounter, and that her future selves are
time consistent. (\citet{odonoghue_choice_2001}). } This allows for some testable predictions. Depending on market structure
(monopoly or perfect competition) and consumer type (degree of time-inconsistency
and sophistication), the contract that addresses the renegotiation
problem will differ in particular, sometimes unexpected, ways from
the standard `full-commitment' contract.
...
This generates some lessons for bank regulation beyond the control
of opaque contracts and exploitation of uninformed consumers. Banks
need tools to be able to offer credible commitment that helps consumers
prevent their present-biased future selves from hurting their long-run
objectives. Our model highlights two channels through which this can
be achieved. First, banks should find it in their interest to make
governance choices (nonprofit, hybrid ownership) that restrict their
incentive to renegotiate contracts. Second, market exclusivity (despite
its obvious disadvantages for other standard reasons) helps banks
make such governance choices.
...
To take one example, the model suggests a way to reconcile the following
phenomena: the ubiquity and persistence of non-profit and social-investor
led firms in microfinance, and the more recent growth of for-profit
microfinance and its apparent association with rising borrower `over-indebtedness'
in some countries.
...
of outcome or concern about deception via hidden actions or hidden
information in a contract. Instead, there is a renegotiation problem
between fully informed and optimizing agents. After a loan or savings
contract is signed and in effect, a present-biased borrower would,
in a later period, become interested in discarding the contract his
period zero self had agreed to and replace it with a new one that
increases present consumption and pushes repayment/savings burdens
further into the future. Since at this later date the client will
be willing to pay to undo her earlier commitment, the bank (or perhaps
one of its competitors) might opportunistically pander to its clients
impulses and rewrite the existing contract to raise its profits. A
sophisticated consumer anticipates this potential renegotiation in
the initial period. In the absence of an outside commitment technology
the consumer and the bank will search for second-best alternatives
in renegotiation-proof contracts, but this implies a reduction in
the feasible contract space and therefore in the total surplus or
gains to trade that can be extracted.

The bank's inability to commit to not pander to (i.e. not wanting
to profit from) the client's later selves' temptation to recontract
can therefore be costly. Since a monopolist always leaves the consumer
at her autarky utility, the renegotiation problem results in lower
profits than under the `full-commitment' contract. We find that the
resulting `renegotiation-proof' contract comes with a relatively larger
consumption in the initial period (i.e. a larger loan or less initial
savings). Since this must imply relatively low consumption in future
periods, the monopolist stands to gain little from rearranging that
consumption, and the contract is renegotiation-proof. Renegotiation-proof
contracts will be feasible only for consumers whose smoothing needs
are relatively large (i.e. reservation utility is sufficiently low
relative to optimal utility); for others, the problem of renegotiation
means that no contract can be offered.

Unlike with sophisticates, with naive hyperbolic discounters the monopolist
benefits from the possibility of renegotiation, since it can make
profits both from the original contract and from renegotiation (which
is unanticipated by the consumer). Here, the initial contract involves
relatively \emph{small} initial consumption. The contract therefore
leaves the consumer with high future consumption, which raises the
profits from renegotiation. The idea that predatory lending to naifs
might involve small, not large, loans is perhaps counter-intuitive,
but is consistent with, for example, payday lending practices that
allow initial small loans to be renegotiated into larger loans over
time. {[}CITATION{]}

Our arguments for competitive banks follow along similar lines, except
that the consequences of failures to commit must always fall on the
consumer (banks make zero profits, so all surplus is returned to the
consumer). Unlike under monopoly, predictions for contract terms are
ambiguous.
...
salience because they are\textit{ less} strict, not more). In addition,
our model provides a partial (though obviously incomplete) explanation
of trends in global microfinance: the proliferation of lenders erodes
the monopoly advantages (through commitment) gained by non-profit
status, which results in a competitive equilibrium where firms switch
to for-profits and commitment properties of contracts are weakened,
resulting in an apparent over-indebtedness.
...
As the consumer's preferences change it will be useful to distinguish between what we will refer to as her period-zero `Zero-self' and her  period-one `One-self'. The Zero-self consumer starts with claims to an existing arbitrary
...
consumption stream. In the absence of access to formal banking she must rely
on `own-savings' or informal borrowing, if available. We denote the
resulting  `autarky' consumption stream C_{0}^{A}$
and its associated present discounted utility by $U_{0}^{A}$.

\subsubsection{Autarky Utility}



Consumption smoothing will in general fall short of the achievable in the absence of financial trade. If
her income is back-heavy, borrowing constraints limit her ability
to smooth consumption, and in the absence of credit she must consume
her income as it arrives.  If her income is front-heavy, with available own-savings strategies
the consumer may be able to construct a somewhat smoothed autarky
stream. In the best of circumstances her optimal consumption
path $C_{0}^{*}$ satisfies $u'\left(c_{0}\right)=\beta \delta (1+r) u'\left(c_{1}\right)=\beta  \delta ^2 (1+r)^2 u'\left(c_{2}\right)$
and $\sum_{t=0}^{2}c_{t}=y$, yielding a corresponding optimal utility
$U_{0}^{*}$.
However there may be technological restrictions to saving
which imply very low and possibly even quite negative returns to saving \(   r\), with insecurity of storing cash at home being an obvious
explanation.

 More relevant to our analysis, however, is that
even with access to perfectly secure savings, a consumer with time-inconsistent
preferences cannot trust her later selves to not undo her preferred
consumption choices. In particular, while the Zero-self may wish
to satisfy $u'\left(c_{1}\right)=\delta u'\left(c_{2}\right)$, her One-self will want to over-consume relative to her wishes, re-optimizing to satisfy  $u'\left(c_{1}\right)=\beta \delta (1+r)u'\left(c_{2}\right)$.
A sophisticated hyperbolic discounter who fully anticipates her changing future
preferences will find herself locked into a strategic game with he latter selves as explained in \citet{basu_commitment_2014} and later in the paper. \ This leads to  imperfectly-smoothed
consumption.\footnote{The  \ stream will be a subgame perfect equilibrium
of the consumption-savings game played by the series of her time-indexed
selves (each with a slightly different objective function). In the
absence of credit and savings constraints, the period 0 self must
solve the following problem: 
\[
\underset{c_{0}}{max}\left[u\left(c_{0}\right)+\beta u\left(c_{1}\left(c_{0}\right)\right)+\beta u\left(c_{2}\left(c_{0}\right)\right)\right]
\]
Since $c_{1}$and $c_{2}$ will be selected in period 1, $c_{1}$
will be larger than $c_{2}$, so period 0's optimal outcome cannot
be achieved. It should also be noted that, in anticipation of period
1's response, depending on parameter values period 0 may save \emph{more
or less} than she optimally would. So access to commitment may actually
reduce the consumer's total savings.} A naive hyperbolic discounter, on the other hand, may believe she
can achieve optimal utility though this will not be realized.

To summarize, for reasons having to do with constraints on borrowing and savings  technologies in the autarky economy
and the self-control struggles associated with time-inconsistent by (partly or fully)\ sophisticated consumers there will be demand for banking contracts with an outside financial
intermediary.
...
\caption{\label{fig:renegotiation}The renegotiation problem illustrated}
...
the same bundle as $u(c_{1})+\beta u(c_{2})$.}. Hence at contract point $F$ in the figure the period 1 self's preferences
...
\begin{figure}
\includegraphics[scale=0.25]{figures}
