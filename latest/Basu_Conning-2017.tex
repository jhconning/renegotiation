...
and/or debt management plans?\  When  might they instead opportunistically
profit by pandering to their consumers' biases? By might financial trade be
distorted by consumer fears that this might happen? We study a consumer
...
\begin{prop}
Assume $\kappa<\bar{\kappa}$. Suppose a firm has the option of adopting
nonprofit status with some $\bar{\alpha}<1$ (while leaving the direct
costs of renegotiation unchanged, so $\eta\left(\bar{\alpha}\right)=\kappa$).
\begin{description}
\item [{(a)}] Under competition: 
\begin{description}
