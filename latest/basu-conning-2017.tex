...
\subsection{When are full-commitment contracts credible?}
...
\begin{equation}
 ...
 \right]\label{eq:kbar}
\end{equation}
The value of $c_1^F$ will differ depending on whether the period 0 market for full-commitment contracts is competitive or monopolized.  Under competition we know from \ref{eq:CF1} that $c_1^F={y}/({1+2\beta^\frac{1}{\rho}})$ so $\bar \kappa$ depends only on $y,\beta$ and $\rho$. This means also that the survival of full-commitment under competition is independent
of autarky utility.
...
Having now characterized the renegotiation problem and conditions for
the survival of full commitment contracts, we turn to the more interesting case where
 renegotiation-proof constraint \ref{eq:no_reneg} binds. We call
