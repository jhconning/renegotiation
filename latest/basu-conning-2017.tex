...
What  is the minimum threshold level of renegotiation costs required to make full-commitment contracts credible?
Suppose that $F$ in figure 2 is the continuation $C_1^F$ of a full commitment  competitive contract from period 0. The cost to the bank of continuing to honor the contract is 
$c_1^{F}+c_2^{F}=2c_1^F$ or distance $ON$ on the diagram.  Renegotiation under monopoly in period 1 would be to  $R$ which lower cost  $OQ$, for a gain in profits $QN$.  If $\kappa=0$ then One-self would gain the most by recontracting to $P$.\footnote{Though we are using the same contract labels  in order to re-use Figure 2 it should be understood that the $F, R$ and $P$ contract points in the period 0 monopoly case will be different from  the similarly named contract points of the last paragraph (they would be better labeled $mF,mR$ and $mP$).}  
If $\kappa>0$ but still not large then a renegotiation would be to a point along the segment $RP$ (which satisfies the FOC\ $u'(c_1^1)=\beta u'(c_2^1))$ that lowers the contract cost to the bank by just enough to entice it to pay renegotiation costs $\kappa$. To  dissuade renegotiation away from a full-commitment contract we need to find the coordinates at $R$ and  with that the renegotiated continuation contract cost $c_1^R+c_2^R$ (or length $ON)$ so as to find the  $\bar \kappa$ that just exceeds this gain in profits from renegotiation (or distance $QN)$. In other words $\bar \kappa=2c_{1}^{F}}-(c_1^R+c_2^R)$. The closed form solution for the CRRA case is in the appendix. Similar reasoning applies to finding the threshold level of renegotiation costs to sustain the period 0 monopoly  full commitment contract $c_2^{mF}$ but as demonstrated in the appendix renegotiation costs large enough to  deter renegotiation of period 0 competitive   full commitment contracts also deter renegotiation of period 0 monopoly full-commitment contracts.  
