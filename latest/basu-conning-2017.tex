...
What  is the minimum renegotiation cost $\bar \kappa$ that insures the survival of full-commitment contracts by deterring renegotiation?
...
$c_1^{F}+c_2^{F}=2c_1^F$ or distance $ON$ on the diagram (measured in period 1 units).  Renegotiation under monopoly in period 1 would be to  $R$ which lower cost  $OQ$, for a gain in profits $QN$.  With $\kappa=0$ and competition for period 1 contracts One-self would be able to recontract to $P$.  
With competition and $\kappa$ positive but not large enough to sustain $F$, renegotiation would be to a point along the segment $RP$ (to satisfy  the FOC\ $u'(c_1^1)=\beta u'(c_2^1))$ that lowers the contract cost to the bank by just enough to entice it to participate and cover its renegotiation costs $\kappa$. To  dissuade renegotiation from a full-commitment contract we need to find the coordinates at $R$ or $C_1^R}=(c_1^1(C_{1}^{F}),c_2^1(C_{1}^{F}))$ and  associated renegotiated continuation contract cost 
$c_1^R+c_2^R$ or length $ON$ in the figure. The renegotiation cost $\bar \kappa$ that just deters renegotiation must be just larger than the potential gain in profits to renegotiation:\begin{equation}
\bar \kappa=2c_{1}^{F}}-(c_1^R+c_2^R)\label{kbar}
\end{equation} or distance $QN$ on the figure. Since we have already derived $C_0^F$ and $(c_1^R,c_2^R)=C_1^R(C_1^F)$ we can also arrive at a closed form solution for $\bar \kappa$. The closed form solution for the CRRA case is in the appendix.  Notice next that we would be led to the same expression for $\bar \kappa$ if the market for period 1 contracts had been monopolized. That's because what really matters is that $\kappa$ be larger than the gains to trade in the period 1 subgame.  Note finally that the minimum level of renegotiation cost $\bar \kappa^m$ to sustain the monopoly full-commitment contract is given by a formula similar to \ref{kbar} except that we would substitute $c_1^{mF}$ and $(c_1^{mR},c_2^{mR})=C_1^{R}(C_1^{mF})$ and into the formula.   However it is easy to establish that $\bar \kappa^m \le \bar \kappa$ since 

XXXXXX     

Similar reasoning applies to finding the threshold level of renegotiation costs to sustain the period 0 monopoly  full commitment contract $c_2^{mF}$ but as demonstrated in the appendix renegotiation costs large enough to  deter renegotiation of period 0 competitive   full commitment contracts also deter renegotiation of period 0 monopoly full-commitment contracts.  

Since full-commitment contracts under competition do not vary with
autarky utility (the period 0 bank zero profit condition binds), the survival of full-commitment is also independent
of autarky utility.
...
\begin{prop}
Consider $\bar{\kappa}$ as defined in appendix equation \ref{eq:max-kappa}.
