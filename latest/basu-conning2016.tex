...
\section{Imperfect Commitment Contracts $(\kappa \geq 0)$}



Having characterized the renegotiation problem, and conditions for the survival of full-commitment contracts, we turn to the interesting intermediate cases between full commitment contracts
and no-commitment where the renegotiation-proof constraint \ref{eq:no_reneg} binds at a $\kappa >0$. We call these imperfect commitment contracts. For sophisticated hyperbolic discounters,
...
participation constraint and the renegotiation-proofness
constraint \ref{eq:no_reneg}. The resulting contract must limit period 1 self's (and
hence also the bank's) potential gains from renegotiation. As long as $\kappa$ is small enough for
...
For, $\kappa>0$, the contract cannot be explicitly derived in closed form, but its
...
states that bank profits will be lower than under full-commitment. The
...
negative profits and therefore no contract is offered to them. This is because
...
is not feasible; the renegotiation-proof contract will involve higher
consumption in period 0 (i.e. either a smaller loan or less savings)
compared to full commitment). The following is a sketch of the argument.
...
the denial of service (rationing) of consumers whose smoothing needs are relatively
small.
