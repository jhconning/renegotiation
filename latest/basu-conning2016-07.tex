...
Equations \ref{eq:FOCc0c1} and \ref{eq:budgetplus} can be used to solve for $c_0$ and consumption in the other periods.  The term $\delta (1+r)$ enters each of the above expressions and essentially `tilts' consumption to be more generally rising or falling over time as  $\delta \gtreqless 1/(1+r)$.  As this general tilt is not essential to our analysis (but the degree of present-bias $\beta$ will be), we shall for theu purposes of simplification and without loss of generality impose the assumption that  \(\delta=\frac{1}{1+r}\) for the remainder of the analysis. The above equations become simply

\begin{equation}
c_1=\beta^\frac{1}{\rho}c_{0} \text{,   }
c_1=\beta^\frac{1}{\rho}c_{0} \text{ and }
